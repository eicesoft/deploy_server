...
type Context interface {
	...
	// ShouldBindFormToMap
	// tag: `form:"xxx"`
	ShouldBindFormToMap(obj map[string]interface{}) error
...
func (c *context) ShouldBindFormToMap(obj map[string]interface{}) error {
	return c.ctx.ShouldBindWith(obj, MapBind)
}
...
func (c *context) Init(logger *zap.Logger) {
...
func (c *context) Fail(code int, err error) {
	c.AbortWithError(errno.NewError(
		http.StatusBadRequest, code, err.Error(),
	))
}

var MapBind = mapBinding{}
...
func (mapBinding) Bind(req *http.Request, obj interface{}) error {
	...
	for k := range req.Form {
		obj.(map[string]interface{})[k] = req.Form.Get(k)
	}
